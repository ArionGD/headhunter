"""
Django settings for the HeadHunt.io project.
...
SECRET_KEY = 'django-insecure-s+k*q!-l7z!a@ru0be2hnrf(w6iwuaj^gmc)pi0rb@%zk+62@t'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.superuser_context',
            ],
        },
    },
]
...
# Database
# High-speed local SQLite for Django ORM + Turso Cloud (libSQL) dual-sync persistence
DATABASES = {
    'default': {
